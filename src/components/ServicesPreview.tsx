    ...
    <div className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-12">
          <div className="bg-white p-6 rounded-2xl shadow-md text-center hover:shadow-lg transition-shadow duration-200">
        ...
        <div className="text-center">
          <a
            href="/services"
            className="bg-crisp-green hover:bg-crisp-green/90 text-white px-8 py-3 rounded-2xl font-medium text-lg transition-colors duration-200"
          >
            View All Services
          </a>
        </div>
